const Key_api = "8Vn95LbvDQpGB42FWAfMS8sAwbXEUlVN";
...
let suggest = () => {
    ...
    if(term != ''){
        ...
        closeSearch.style.padding = '3.5px';
    }
    if(termNav != ''){
        closeSearchNav.setAttribute('src', './assets/close.svg');
        closeSearchNav.style.padding = '3.5px';
    }
...
let renderHTMLslider = (gif) => {
    ...
    max.src = "./assets/icon-max-normal.svg";
        ...
        <img src="./assets/close.svg" alt="close icon" id="close-modal"/><div class="modal__content__card">
            ...
            <div class="modal__content__card__info">
                ...
                <div class="modal__content__card__info__images">
                    ...
                    <img src="./assets/icon-download-hover.svg" alt="icono de descarga" class="download__icon"  data-id="${id}" onclick="descargarGif('${gif.image},${gif.title}')" />
                </div>
            </div>
        </div>`;
